...
//        die;
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('tip_price', array(
            'header' => Mage::helper('sales')->__('Tip Amount'),
            'type' => 'currency',
            'currency' => 'order_currency_code',
            'index' => 'tip_price',
            'filter_index' => 'price'
        ...
        $this->addColumn('item_sku', array(
            ...
            'index' => 'item_sku',
            'filter_index' => 'sales_order_item.sku',
        ));
        $this->addColumn('action', array(
            'header' => Mage::helper('tiporders')->__('Action'),
            'width' => '100',
            'type' => 'action',
            'getter' => 'getId',
            'actions' => array(
                array(
                    'caption' => Mage::helper('tiporders')->__('View Order'),
