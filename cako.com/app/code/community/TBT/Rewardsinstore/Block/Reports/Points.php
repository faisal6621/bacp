...
class TBT_Rewardsinstore_Block_Reports_Points extends Mage_Adminhtml_Block_Dashboard_Bar
{
    ...
    protected function _prepareLayout()
    {
        ...
        $totalPoints = Mage::helper('rewardsinstore/points')->getPointsString(array(1 => $totalPoints));
        $this->addTotal($this->__('Lifetime Points Awarded Instore'), $totalPoints, true);
        ...
        $avgPoints = Mage::helper('rewardsinstore/points')->getPointsString(array(1 => $avgPoints));
        $this->addTotal($this->__('Average Points Per Instore Order'), $avgPoints, true);
    }
}
