<?php
class Ciplex_Sales2_Adminhtml_Sales3Controller extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    {
				return Mage::getSingleton('admin/session')->isAllowed('sales/sales3backend');
    }
    ...
    {
        $fileName   = 'orders.csv';
        $grid       = $this->getLayout()->createBlock('sales2/adminhtml_sales3_grid');
