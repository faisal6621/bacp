...
class TBT_Rewards_Block_Manage_Transfer_Edit_Tab_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareColumns() {
		...
		$this->addColumn ( 'points', array ('header' => Mage::helper ( 'rewards' )->__ ( 'Points' ), 'width' => '220px', 'index' => 'customer_id', 'renderer' => 'rewards/manage_grid_renderer_points2', 'sortable' => false, 'filter' => false ) );
		//
