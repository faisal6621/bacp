...
class TBT_Rewardsinstore_Helper_Points extends Mage_Core_Helper_Abstract
{
    ...
    public function getPointsString($pointsArray)
    {
        $pointsString = Mage::helper('rewards')->getPointsString($pointsArray);
        $parts = explode(" ", $pointsString);
        $parts[0] = Zend_Locale_Format::toNumber($parts[0],
            array('locale' => Mage::app()->getLocale()->getLocaleCode())
        );
        $pointsString = implode(" ", $parts);
        return $pointsString;
    }
}
