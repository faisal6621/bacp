...
{
    const PATH_LOG_FILE     = 'rewardsinstore.log';
    const PATH_ERROR_FILE   = 'rewardsinstore.error.log';
    ...
    {
        Mage::log($msg, $level, self::PATH_LOG_FILE);
    }
    
    public function logError($msg) {
        Mage::log($msg, Zend_Log::ERR, self::PATH_ERROR_FILE);
    }
    ...
    {
        Mage::log("\n" . $ex->__toString(), Zend_Log::ERR, self::PATH_ERROR_FILE);
    }
}
