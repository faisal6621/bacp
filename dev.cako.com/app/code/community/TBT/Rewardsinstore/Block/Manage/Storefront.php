 ...
 */
class TBT_Rewardsinstore_Block_Manage_Storefront extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->setTemplate ( 'rewardsinstore/widget/grid/container.phtml' );
        parent::__construct();
    }
