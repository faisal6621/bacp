...
class Excellence_Cblocks_Block_Adminhtml_Images_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function getHeaderText() {
        if (Mage::registry('images_data') && Mage::registry('images_data')->getId()) {
            return Mage::helper('cblocks')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('images_data')->getTitle()));
        } else {
